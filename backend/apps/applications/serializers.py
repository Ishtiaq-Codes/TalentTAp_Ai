...
class ApplicationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Application
        fields = [
            'id', 'job', 'candidate', 'candidate_user_id', 'candidate_name', 'candidate_headline', 'candidate_avatar',
...
class ShortlistSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Shortlist
        fields = [
            'id', 'recruiter', 'candidate', 'candidate_user_id', 'candidate_name', 'candidate_avatar',
