...
def generate_job_description_stream(title, experience_level, salary_range, location, job_type, skills):
    """
    Generates a professional job description draft using Gemini AI as a stream.
    """
...
"""
    ...
    yield from generate_text_stream(prompt, temperature=0.5)
