    ...
    <div className="space-y-6 animate-fade-in">
      ...
      {list.length === 0 ? (
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {list.map(item => (
            <div key={item.id} className="group relative flex flex-col justify-between rounded-2xl border bg-white p-5 shadow-sm transition-all hover:shadow-md hover:border-primary/30">
