  ...
  <div className="space-y-8 animate-fade-in max-w-7xl mx-auto">
   ...
   {jobList.length === 0 ? (
    ...
    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
     {jobList.map((job) => (
      <div key={job.id} className="group relative flex flex-col justify-between glass-card rounded-2xl p-6 transition-all hover:shadow-xl hover:border-primary/40 hover:-translate-y-1">
