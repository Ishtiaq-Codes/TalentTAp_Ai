...
function PostCard({ post, featured = false }) {
 ...
 if (featured) {
  return (
   <Link to={`/blog/${post.slug}`} className="group relative flex flex-col overflow-hidden glass-card rounded-2xl transition-all hover:shadow-xl hover:-translate-y-1">
 ...
 return (
  <Link to={`/blog/${post.slug}`} className="group flex gap-4 glass-card rounded-xl p-4 transition-all hover:shadow-md hover:-translate-y-0.5">
   ...
   <section className="bg-white pt-32 pb-16 border-b border-slate-100">
    <div className="mx-auto max-w-7xl px-4 sm:px-6">
     <div className="text-center">
      ...
      {/* Search */}
      <form onSubmit={handleSearch} className="mx-auto mt-8 flex max-w-xl items-center gap-2 glass-card rounded-2xl p-2">
